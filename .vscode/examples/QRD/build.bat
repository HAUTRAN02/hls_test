@echo off
set "SOURCE_FILES=MGS.cpp QRD_Testbench.cpp TestbenchHelpers.cpp"
set "HLS_CXX_FLAGS=-ffp-contract=fast -ffp-reassociate"
...
if "%TARGET%" == "test-x86-64" (
  ...
  set "CXX=cl"
  set "CXXFLAGS=/std:c++17 /I ""%HLS_INSTALL_DIR%\include"" /nologo /EHsc /wd4068 /DWIN32 /MD"
