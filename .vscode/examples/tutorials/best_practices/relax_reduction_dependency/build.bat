...
if "%TARGET%" == "default" (
  ...
  echo i++ -march=%DEVICE% part_2_shift_register.cpp -o part_2_shift_register.exe
  i++ -march=%DEVICE% part_2_shift_register.cpp -o part_2_shift_register.exe
  if not ERRORLEVEL 0 (
    echo Error: Compile failed
    exit /b 1
  )
  ...
  part_1_naive.exe
  echo part_2_shift_register.exe
  part_2_shift_register.exe
  ...
  echo i++ -march=%DEVICE% --quartus-compile part_2_shift_register.cpp -o part_2_shift_register.exe
  i++ -march=%DEVICE% --quartus-compile part_2_shift_register.cpp -o part_2_shift_register.exe
  if not ERRORLEVEL 0 (
    echo Error: Compile failed
    exit /b 1
  )
  ...
  rmdir /s /q part_2_shift_register.prj 2>nul
  goto:eof
) else (
  goto usage
)
