...
set DESIGNS=part_1_loop_carried_dependency part_2_no_loop_carried_dependency
...
if "%TARGET%" == "default" (
  ...
  echo Compilation complete.  Open the README and the report files to examine the impact of loop carried dependencies.
  goto:eof
