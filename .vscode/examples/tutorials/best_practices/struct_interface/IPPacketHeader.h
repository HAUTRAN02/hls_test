...
constexpr int PACKET_LENGTH    = 160;
constexpr int BITS_VERSION     = 4;
constexpr int BITS_IHL         = 4;
constexpr int BITS_DSCP        = 6;
constexpr int BITS_ECN         = 2;
constexpr int BITS_TOTAL_LENGTH= 16;
constexpr int BITS_ID          = 16;
constexpr int BITS_FLAG        = 3;
constexpr int BITS_FO          = 13;
constexpr int BITS_TTL         = 8;
constexpr int BITS_PROTOCAL    = 8;
constexpr int BITS_CHECKSUM    = 16;
constexpr int BITS_SRC_IP      = 32;
constexpr int BITS_DST_IP      = 32;

constexpr int OFFSET_VERSION     = PACKET_LENGTH      - BITS_VERSION;
constexpr int OFFSET_IHL         = OFFSET_VERSION     - BITS_IHL;
constexpr int OFFSET_DSCP        = OFFSET_IHL         - BITS_DSCP;
constexpr int OFFSET_ECN         = OFFSET_DSCP        - BITS_ECN;
constexpr int OFFSET_TOTAL_LENTH = OFFSET_ECN         - BITS_TOTAL_LENGTH ;
constexpr int OFFSET_ID          = OFFSET_TOTAL_LENTH - BITS_ID;
constexpr int OFFSET_FLAG        = OFFSET_ID          - BITS_FLAG;
constexpr int OFFSET_FO          = OFFSET_FLAG        - BITS_FO ;
constexpr int OFFSET_TTL         = OFFSET_FO          - BITS_TTL;
constexpr int OFFSET_PROTOCAL    = OFFSET_TTL         - BITS_PROTOCAL;
constexpr int OFFSET_CHECKSUM    = OFFSET_PROTOCAL    - BITS_CHECKSUM;
constexpr int OFFSET_SRC_IP      = OFFSET_CHECKSUM    - BITS_SRC_IP;
constexpr int OFFSET_DST_IP      = OFFSET_SRC_IP      - BITS_DST_IP;
...
public:
  IPPacketHeader_padding(const char * str) : version(0), ilh(0), dscp(0), ecn(0), length(0), ID(0), flag(0), FO(0), TTL(0), protocal(0), checksum(0), s_ip(0), d_ip(0) {
    whole_packet_t temp = ac::bit_fill_hex<whole_packet_t>(str);
...
public:
  IPPacketHeader_no_padding (const char * str) : h(0) {
    h = ac::bit_fill_hex<whole_packet_t>(str);
  }
