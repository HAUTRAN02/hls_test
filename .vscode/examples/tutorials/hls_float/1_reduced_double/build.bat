...
set DESIGNS=part1_native_type part2_reduce_double
...
if "%TARGET%" == "default" (
  ...
  echo Compilation complete. Open the README and the report files to learn how to use customized hls_float type instead of double
  goto:eof
