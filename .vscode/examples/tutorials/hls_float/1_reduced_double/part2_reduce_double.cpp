...
// we set the rounding mode to RZERO (truncate to zero)
// because this allows us to generate compile-time hls_float
// constants from double type literals shown below, which
// eliminates the area usage for initialization.
constexpr auto Rnd = ihc::fp_config::FP_Round::RZERO;
using double_type  = ihc::hls_float<11, 44, Rnd>;
