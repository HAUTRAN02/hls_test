...
set DESIGNS=part1_operator part2_explicit
...
if "%TARGET%" == "default" (
  ...
  echo Compilation complete. Open the README and the report files to learn how to use use explicit binary operations
  goto:eof
