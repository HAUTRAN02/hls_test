...
component
void threshold(ihc::stream_in<unsigned char,  ihc::usesPackets<true> >&  in_pixel, 
               ihc::stream_out<unsigned char, ihc::usesPackets<true> >& out_pixel
              ) {
...
int main(void) {
  ...
  // image streams
  ihc::stream_in<unsigned char,  ihc::usesPackets<true> >  in_pixel;
  ihc::stream_out<unsigned char, ihc::usesPackets<true> > out_pixel;
