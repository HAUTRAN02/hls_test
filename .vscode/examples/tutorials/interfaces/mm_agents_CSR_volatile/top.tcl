...
proc do_create_top {} {
	...
	# add the components
	add_component CSR_volatile_internal_0 part_3_CSR_volatile.prj/components/CSR_volatile/CSR_volatile.ip CSR_volatile_internal CSR_volatile_internal_inst 1.0
	load_component CSR_volatile_internal_0
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation CSR_volatile_internal_0
	set_instantiation_assignment_value hls.compressed.name {CSR_volatile}
	set_instantiation_assignment_value hls.cosim.name {_Z12CSR_volatilePVi}
	...
	set_instantiation_interface_parameter_value avs_a addressSpan {32}
	...
	set_instantiation_interface_parameter_value avs_a readLatency {4}
	...
	set_instantiation_interface_assignment_value avs_a hls.cosim.name {e}
	set_instantiation_interface_sysinfo_parameter_value avs_a address_map {<address-map><slave name='avs_a' start='0x0' end='0x20' datawidth='32' /></address-map>}
	set_instantiation_interface_sysinfo_parameter_value avs_a address_width {5}
	...
	add_instantiation_interface_port avs_a avs_a_address address 3 STD_LOGIC_VECTOR Input
	...
	save_instantiation
	add_component poll_memory_internal_0 part_1_enqueue_nonvolatile.prj/components/poll_memory/poll_memory.ip poll_memory_internal poll_memory_internal_inst 1.0
	load_component poll_memory_internal_0
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation poll_memory_internal_0
	set_instantiation_assignment_value hls.compressed.name {poll_memory}
	set_instantiation_assignment_value hls.cosim.name {_Z23poll_memoryPi}
	add_instantiation_interface clock clock INPUT
	set_instantiation_interface_parameter_value clock clockRate {0}
	set_instantiation_interface_parameter_value clock externallyDriven {false}
	set_instantiation_interface_parameter_value clock ptfSchematicName {}
	...
	set_instantiation_interface_parameter_value avs_a addressAlignment {DYNAMIC}
	set_instantiation_interface_parameter_value avs_a addressGroup {0}
	set_instantiation_interface_parameter_value avs_a addressSpan {8}
	set_instantiation_interface_parameter_value avs_a addressUnits {WORDS}
	set_instantiation_interface_parameter_value avs_a alwaysBurstMaxBurst {false}
	set_instantiation_interface_parameter_value avs_a associatedClock {clock}
	set_instantiation_interface_parameter_value avs_a associatedReset {reset}
	...
	set_instantiation_interface_sysinfo_parameter_value avs_a address_map {<address-map><slave name='avs_a' start='0x0' end='0x8' datawidth='32' /></address-map>}
	set_instantiation_interface_sysinfo_parameter_value avs_a address_width {3}
	set_instantiation_interface_sysinfo_parameter_value avs_a max_slave_data_width {32}
	add_instantiation_interface_port avs_a avs_a_read read 1 STD_LOGIC Input
	add_instantiation_interface_port avs_a avs_a_readdata readdata 32 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port avs_a avs_a_write write 1 STD_LOGIC Input
	add_instantiation_interface_port avs_a avs_a_writedata writedata 32 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port avs_a avs_a_address address 1 STD_LOGIC Input
	add_instantiation_interface_port avs_a avs_a_byteenable byteenable 4 STD_LOGIC_VECTOR Input
	save_instantiation
	add_component poll_memory_volatile_internal_0 part_2_enqueue_volatile.prj/components/poll_memory_volatile/poll_memory_volatile.ip poll_memory_volatile_internal poll_memory_volatile_internal_inst 1.0
	load_component poll_memory_volatile_internal_0
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation poll_memory_volatile_internal_0
	set_instantiation_assignment_value hls.compressed.name {poll_memory_volatile}
	set_instantiation_assignment_value hls.cosim.name {_Z20poll_memory_volatilePVi}
	add_instantiation_interface clock clock INPUT
	set_instantiation_interface_parameter_value clock clockRate {0}
	set_instantiation_interface_parameter_value clock externallyDriven {false}
	set_instantiation_interface_parameter_value clock ptfSchematicName {}
	...
	set_component_parameter_value gui_operation_mode {source synchronous}
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {true}
	save_component
	load_instantiation top_iopll_0
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {true}
	save_component
	load_instantiation top_synchronizer_0
	add_instantiation_interface clock clock INPUT
	set_instantiation_interface_parameter_value clock clockRate {0}
	set_instantiation_interface_parameter_value clock externallyDriven {false}
	set_instantiation_interface_parameter_value clock ptfSchematicName {}
	...
	add_connection reset_in.out_reset/poll_memory_internal_0.reset
	add_connection reset_in.out_reset/poll_memory_volatile_internal_0.reset
	add_connection reset_in.out_reset/top_iopll_0.reset
	add_connection reset_in.out_reset/top_synchronizer_0.resetn
	add_connection top_iopll_0.outclk0/CSR_volatile_internal_0.clock
	add_connection top_iopll_0.outclk0/poll_memory_internal_0.clock
	add_connection top_iopll_0.outclk0/poll_memory_volatile_internal_0.clock
	add_connection top_iopll_0.outclk0/top_synchronizer_0.clock
	add_connection top_iopll_0.outclk1/CSR_volatile_internal_0.clock2x
	add_connection top_iopll_0.outclk1/poll_memory_internal_0.clock2x
	add_connection top_iopll_0.outclk1/poll_memory_volatile_internal_0.clock2x
	add_connection top_synchronizer_0.resetn_out/CSR_volatile_internal_0.reset

	# add the exports
	set_interface_property CSR_volatile_internal_0_avs_a EXPORT_OF CSR_volatile_internal_0.avs_a
	set_interface_property clk EXPORT_OF clock_in.in_clk
	set_interface_property poll_memory_internal_0_call EXPORT_OF poll_memory_internal_0.call
	set_interface_property poll_memory_internal_0_return EXPORT_OF poll_memory_internal_0.return
	set_interface_property poll_memory_internal_0_avs_a EXPORT_OF poll_memory_internal_0.avs_a
	set_interface_property poll_memory_volatile_internal_0_call EXPORT_OF poll_memory_volatile_internal_0.call
	set_interface_property poll_memory_volatile_internal_0_return EXPORT_OF poll_memory_volatile_internal_0.return
	set_interface_property poll_memory_volatile_internal_0_avs_a EXPORT_OF poll_memory_volatile_internal_0.avs_a
	set_interface_property reset EXPORT_OF reset_in.in_reset
	set_interface_property top_iopll_0_locked EXPORT_OF top_iopll_0.locked

	# set the the module properties
	set_module_property BONUS_DATA {<?xml version="1.0" encoding="UTF-8"?>
<bonusData>
 <element __value="CSR_volatile_internal_0">
  <datum __value="_sortIndex" value="3" type="int" />
 </element>
 <element __value="clock_in">
  <datum __value="_sortIndex" value="0" type="int" />
 </element>
 <element __value="poll_memory_internal_0">
  <datum __value="_sortIndex" value="6" type="int" />
 </element>
 <element __value="poll_memory_volatile_internal_0">
