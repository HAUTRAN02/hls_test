...
set DESIGNS=part_1_pointer part_2_mm_host part_3_mm_agent part_4_stream part_5_pass_by_value
...
if "%TARGET%" == "default" (
  ...
  del /s /f *.exe
  del /s /f *.obj
  rmdir /s /q part_1__pointer.prj 2>nul
  rmdir /s /q part_2_mm_host.prj 2>nul
  rmdir /s /q part_3_mm_agent.prj 2>nul
  rmdir /s /q part_4_stream.prj 2>nul
  rmdir /s /q part_5_pass_by_value.prj 2>nul
  goto:eof
) else (
  goto usage
)
