...
if "%TARGET%" == "default" (
  echo i++ -march=%DEVICE% part_1_unbalanced.cpp -o part_1_unbalanced.exe -ghdl
  i++ -march=%DEVICE% part_1_unbalanced.cpp -o part_1_unbalanced.exe -ghdl
  if not ERRORLEVEL 0 (
    echo Error: Compile failed
    exit /b 1
  )

  echo i++ -march=%DEVICE% part_2_balanced.cpp -o part_2_balanced.exe -ghdl
  i++ -march=%DEVICE% part_2_balanced.cpp -o part_2_balanced.exe -ghdl
  if not ERRORLEVEL 0 (
    echo Error: Compile failed
    exit /b 1
  )
