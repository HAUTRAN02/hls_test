...
// SystemVerilog created from bb_pred_B24_stall_region
...
module pred_bb_B24_stall_region (
    output wire [0:0] out_c0_exe7126516,
    ...
    assign bubble_join_stall_entry_q = in_c0_exe7126516;

    // bubble_select_stall_entry(BITSELECT,12)
    assign bubble_select_stall_entry_b = $unsigned(bubble_join_stall_entry_q[0:0]);

    // dupName_0_sync_out_x(GPOUT,2)@0
    assign out_c0_exe7126516 = bubble_select_stall_entry_b;
