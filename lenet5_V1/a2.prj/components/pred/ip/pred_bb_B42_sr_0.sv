...
// SystemVerilog created from bb_pred_B42_sr_0
...
module pred_bb_B42_sr_0 (
    ...
    // combined_valid(LOGICAL,62)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,65)
