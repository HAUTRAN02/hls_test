...
// SystemVerilog created from flt_i_sfc_logic_s_c0_in_for_body5_i_preds_c0_enter1656121_pred0_castBlock_typeSFloatIEEE_52_11_typeSFloatIEEE_23_8_castModeConvert_3k5ih687ce8eekfqsfwthw0n9ki063065063663c65c62i65i63o63u65u65162763j63p612c4e61k64ki13643609c4l60uq5ux5gv8yll5gvbyxk5mx06of0cd16ol0cd06cj0qfzo
...
module pred_flt_i_sfc_logic_s_c0_in_for_body5_i0000f0cd16ol0cd06cj0qfzo (
    ...
    reg [22:0] redist2_fracR_uid30_block_rsrvd_fix_b_3_q;
    reg [22:0] redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_0;
    reg [22:0] redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_1;
    ...
    begin
        if (!resetn)
        begin
            expFracR_uid29_block_rsrvd_fix_o <= 38'b0;
        end
        else
        begin
    ...
    begin
        ...
        begin
            ...
            redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_1 <= '0;
            redist2_fracR_uid30_block_rsrvd_fix_b_3_q <= '0;
        end
        else
        begin
            redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_0 <= $unsigned(fracR_uid30_block_rsrvd_fix_b);
            redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_1 <= redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_0;
            redist2_fracR_uid30_block_rsrvd_fix_b_3_q <= redist2_fracR_uid30_block_rsrvd_fix_b_3_delay_1;
        end
    end
