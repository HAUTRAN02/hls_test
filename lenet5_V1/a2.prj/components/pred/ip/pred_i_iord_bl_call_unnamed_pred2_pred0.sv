...
// SystemVerilog created from i_iord_bl_call_pred_unnamed_pred2_pred0
...
module pred_i_iord_bl_call_unnamed_pred2_pred0 (
    ...
    // iord(EXTIFACE,8)
    assign iord_i_fifodata = in_iord_bl_call_pred_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_pred_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_pred_i_fifodata),
    ...
    assign out_iord_bl_call_pred_o_fifoready = iord_o_fifoready;
    ...
    assign out_iord_bl_call_pred_o_fifoalmost_full = iord_o_fifoalmost_full;
