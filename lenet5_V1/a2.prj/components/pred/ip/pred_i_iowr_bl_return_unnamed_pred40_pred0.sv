...
// SystemVerilog created from i_iowr_bl_return_pred_unnamed_pred40_pred0
...
module pred_i_iowr_bl_return_unnamed_pred40_pred0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_pred_i_fifoready;
    ...
    assign out_iowr_bl_return_pred_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_return_pred_o_fifodata = iowr_o_fifodata;
