...
// SystemVerilog created from pred_B3_branch
...
module pred_B3_branch (
    input wire [31:0] in_c0_exe10,
    input wire [31:0] in_c0_exe11,
    input wire [0:0] in_c0_exe12,
    input wire [31:0] in_c0_exe1859,
    input wire [31:0] in_c0_exe2860,
    input wire [31:0] in_c0_exe3861,
    input wire [0:0] in_c0_exe5863,
    ...
    // out_c0_exe1859(GPOUT,18)
    assign out_c0_exe1859 = in_c0_exe1859;

    // out_c0_exe2860(GPOUT,19)
    assign out_c0_exe2860 = in_c0_exe2860;

    // out_c0_exe3861(GPOUT,20)
    assign out_c0_exe3861 = in_c0_exe3861;

    // out_c0_exe5863(GPOUT,21)
    assign out_c0_exe5863 = in_c0_exe5863;
