...
// SystemVerilog created from bb_pred_B11_stall_region
...
module pred_bb_B11_stall_region (
    output wire [0:0] out_c0_exe39705,
    output wire [0:0] out_c0_exe49716,
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe49716, in_c0_exe39705};
    ...
    assign out_c0_exe39705 = bubble_select_stall_entry_b;
    assign out_c0_exe49716 = bubble_select_stall_entry_c;
