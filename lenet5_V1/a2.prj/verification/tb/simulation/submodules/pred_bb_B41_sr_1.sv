...
// SystemVerilog created from bb_pred_B41_sr_1
...
module pred_bb_B41_sr_1 (
    ...
    // combined_valid(LOGICAL,74)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,77)
