...
component void pred(hls_avalon_agent_memory_argument(28 * 28 * 2)  fixed_9_2_t *image,
                    hls_avalon_agent_memory_argument(6 * 2) fixed_9_2_t *w_conv1,
                    hls_avalon_agent_memory_argument(6 * 2) fixed_9_2_t *b_conv1,
                    hls_avalon_agent_memory_argument(6 * 28 * 28 * 2) fixed_9_2_t *o_conv1)
{
