...
if {$tcl_platform(platform) == "windows"} {
  cd tb/simulation
  set QSYS_SIMDIR .
  set fname_svlib "C:/intelFPGA_lite/21.1/hls/windows64/bin/hls_cosim_msim32"
  set fname_svlib [string map { "\\" "/"} $fname_svlib]
  source $QSYS_SIMDIR/mentor/msim_setup.tcl
} else {
  set QSYS_SIMDIR tb/simulation
  set fname_svlib "C:/intelFPGA_lite/21.1/hls/host/linux64/lib/libhls_cosim_msim32"
