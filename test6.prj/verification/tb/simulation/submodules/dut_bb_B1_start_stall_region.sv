...
module dut_bb_B1_start_stall_region (
    ...
    wire [0:0] GND_q;
    wire [15:0] bgTrunc_i_add_i_i_dut4_sel_x_b;
    ...
    wire [15:0] i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifodata;
    wire [0:0] i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifovalid;
    wire [0:0] i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_stall;
    wire [0:0] i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_valid;
    ...
    wire [15:0] c_i16_2569_q;
    wire [0:0] dut_B1_start_merge_reg_out_stall_out;
    wire [0:0] dut_B1_start_merge_reg_out_valid_out;
    wire [16:0] i_add_i_i_dut4_a;
    wire [16:0] i_add_i_i_dut4_b;
    logic [16:0] i_add_i_i_dut4_o;
    wire [16:0] i_add_i_i_dut4_q;
    ...
    wire [0:0] SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_wireValid;
    wire [0:0] SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_backStall;
    ...
    // dut_B1_start_merge_reg(BLACKBOX,15)@0
    ...
    // SE_out_dut_B1_start_merge_reg(STALLENABLE,52)
    // Valid signal propagation
    ...
    // i_sfc_s_c0_in_wt_entry_duts_c0_enter1_dut0_aunroll_x(BLACKBOX,9)@1
    ...
    // SE_out_i_sfc_s_c0_in_wt_entry_duts_c0_enter1_dut0_aunroll_x(STALLENABLE,50)
    // Valid signal propagation
    ...
    // SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x(STALLENABLE,48)
    // Backward Stall generation
    assign SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_backStall = $unsigned(1'b0);
    // Computing multiple Valid(s)
    assign SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_wireValid = i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_valid;

    // c_i16_2569(CONSTANT,12)
    assign c_i16_2569_q = $unsigned(16'b0000000100000000);

    // bubble_join_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x(BITJOIN,38)
    ...
    // bubble_select_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x(BITSELECT,39)
    ...
    // i_add_i_i_dut4(ADD,20)@1
    assign i_add_i_i_dut4_a = {1'b0, bubble_select_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x_b};
    assign i_add_i_i_dut4_b = {1'b0, c_i16_2569_q};
    assign i_add_i_i_dut4_o = $unsigned(i_add_i_i_dut4_a) + $unsigned(i_add_i_i_dut4_b);
    assign i_add_i_i_dut4_q = i_add_i_i_dut4_o[16:0];

    // bgTrunc_i_add_i_i_dut4_sel_x(BITSELECT,2)@1
    assign bgTrunc_i_add_i_i_dut4_sel_x_b = i_add_i_i_dut4_q[15:0];

    // i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x(BLACKBOX,8)@1
    // in in_i_stall@20000000
    // out out_iowr_bl_return_dut_o_fifodata@20000000
    // out out_iowr_bl_return_dut_o_fifovalid@20000000
    // out out_o_stall@20000000
    dut_i_iowr_bl_return_unnamed_dut4_dut0 thei_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x (
        .in_i_data_0_tpl(bgTrunc_i_add_i_i_dut4_sel_x_b),
        .in_i_stall(SE_out_i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_backStall),
        ...
        .out_iowr_bl_return_dut_o_fifodata(i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifodata),
        .out_iowr_bl_return_dut_o_fifovalid(i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifovalid),
        .out_o_ack(),
        .out_o_stall(i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_stall),
        .out_o_valid(i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_valid),
        .clock(clock),
        .resetn(resetn)
    );

    // SE_out_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x(STALLENABLE,46)
    ...
    assign SE_out_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x_consumed1 = (~ (i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_o_stall) & SE_out_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x_wireValid) | SE_out_i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x_fromReg1;
    // Consuming
    ...
    // i_iord_bl_call_dut_unnamed_dut2_dut1_aunroll_x(BLACKBOX,7)@1
    // in in_i_stall@20000000
    ...
    assign out_iowr_bl_return_dut_o_fifodata = i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifodata;
    assign out_iowr_bl_return_dut_o_fifovalid = i_iowr_bl_return_dut_unnamed_dut4_dut6_aunroll_x_out_iowr_bl_return_dut_o_fifovalid;
